...
# add the path of the paerent parent directory 
import sys
...
def load_gaussians(input_dir: str = None):
    ...
    gaussians = GaussianModel(0) # GaussianModel(3) # Ruihan 2025-01-27: the original implementation uses sh_degree=3. Change to 0 here for custom asset.
